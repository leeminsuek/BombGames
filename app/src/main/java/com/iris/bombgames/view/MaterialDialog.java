...
public class MaterialDialog {
    ...
    public MaterialDialog setPositiveButton(String text, final OnEditDismissListener listener) {
        mPositiveButton = new Button(mContext);
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT,
                LinearLayout.LayoutParams.WRAP_CONTENT
    ...
    private class Builder {
        ...
        public MaterialEditText mMessageView;
...
//7
            ...
            mMessageView = (MaterialEditText) mAlertDialogWindow.findViewById(R.id.message);
